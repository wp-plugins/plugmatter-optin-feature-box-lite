...
jQuery._farbtastic = function (container, callback) {
  ...
  // Insert markup
  jQuery(container).html('<div class="farbtastic_con"><div class="farbtastic"><div class="color"></div><div class="wheel"></div><div class="overlay"></div><div class="h-marker marker"></div><div class="sl-marker marker"></div></div><div class="sl-hex-code">Hex Code<div><input type="text" size="7" class="farbtastic_txt_hex" /></div></div></div>');
  ...
  fb.updateDisplay = function () {
    ...
    if (typeof fb.callback == 'object') {
      ...
      jQuery(".farbtastic_txt_hex").val(fb.color);
    }
  }
  ...
  fb.setColor('#000000');
	...
	jQuery(".farbtastic_txt_hex").keypress(function(event){
